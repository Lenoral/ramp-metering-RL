...
class Actor(nn.Module):
	def __init__(self, state_dim, action_dim, max_action, phi=0):
...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim):
		...
		self.l5 = nn.Linear(40, 20)
		self.l6 = nn.Linear(20, 1)
...
class VAE(nn.Module):
	def __init__(self, state_dim, action_dim, latent_dim, max_action, device):
		...
		self.e1 = nn.Linear(state_dim + action_dim, 20)
		self.e2 = nn.Linear(20, 20)
		self.e3 = nn.Linear(20, 20)

		self.mean = nn.Linear(20, latent_dim)
		self.log_std = nn.Linear(20, latent_dim)

		self.d1 = nn.Linear(state_dim + latent_dim, 20)
		self.d2 = nn.Linear(20, 20)
		self.d3 = nn.Linear(20, 20)
		self.d4 = nn.Linear(20, action_dim)
	...
	def decode(self, state, z=None):
		...
		a = F.relu(self.d2(a))
		a = F.relu(self.d3(a))
		return self.max_action * torch.tanh(self.d4(a))
		


class BCQ(object):
	def __init__(self, state_dim, action_dim, max_action, device, discount=0.99, tau=0.005, lmbda=0.75, phi=0):
